package com.lushihao.myutils.charset;

import com.lushihao.myutils.charset.helper.CharsetHelper;
import com.lushihao.myutils.string.LSHStringUtils;
 ...
 * 编码相关的封装类
 */
public final class LSHCharsetUtils {
    ...
    public final static String toASCII(String str) throws UnsupportedEncodingException {
        return changeCharset(str, CharsetHelper.US_ASCII);
    }
    ...
    public final static String toISO_8859_1(String str) throws UnsupportedEncodingException {
        return changeCharset(str, CharsetHelper.ISO_8859_1);
    }
    ...
    public static String toUTF_8(String str) throws UnsupportedEncodingException {
        return changeCharset(str, CharsetHelper.UTF_8);
    }
    ...
    public final static String toUTF_16BE(String str) throws UnsupportedEncodingException {
        return changeCharset(str, CharsetHelper.UTF_16BE);
    }
    ...
    public final static String toUTF_16LE(String str) throws UnsupportedEncodingException {
        return changeCharset(str, CharsetHelper.UTF_16LE);
    }
    ...
    public final static String toUTF_16(String str) throws UnsupportedEncodingException {
        return changeCharset(str, CharsetHelper.UTF_16);
    }
    ...
    public final static String toGBK(String str) throws UnsupportedEncodingException {
        return changeCharset(str, CharsetHelper.GBK);
    }
    ...
    public final static String getDefaultCharSet() throws UnsupportedEncodingException {
        OutputStreamWriter writer = new OutputStreamWriter(new ByteArrayOutputStream(), CharsetHelper.UTF_8);
    ...
    public final static String toGBKWithUTF8(String input) throws UnsupportedEncodingException {
        if (LSHStringUtils.isEmpty(input)) {
            return "";
        } else {
            String s1;
            s1 = new String(input.getBytes(CharsetHelper.ISO_8859_1), CharsetHelper.GBK);
            return s1;
        }
    }
    ...
    public final static String toUnicodeWithGBK(String input) throws UnsupportedEncodingException {
        if (LSHStringUtils.isEmpty(input)) {
            ...
            String s1;
            s1 = new String(input.getBytes(CharsetHelper.GBK), CharsetHelper.ISO_8859_1);
            return s1;
        }
    }
